    ...
    def sort_points(self):
        ...
        for i, pt in enumerate(self.active_points):
            ...
            if i == 0 or i == n-1:
                ...
                pt.delete_button.grid(row=i, column=13, sticky="e", padx=5, pady=5)

            # Hide x minus on end point
            if i == n-1:
                pt.X_decrease_button_small.grid_forget()
                pt.X_decrease_button_large.grid_forget()

            else:
                pt.X_decrease_button_large.grid(row=i, column=1, sticky="e", padx=5, pady=5)
                pt.X_decrease_button_small.grid(row=i, column=2, sticky="e", padx=5, pady=5)

            # Hide x plus on end point
            if i == 0:
                pt.X_increase_button_small.grid_forget()
                pt.X_increase_button_large.grid_forget()
            else:
                pt.X_increase_button_small.grid(row=i, column=4, sticky="w", padx=5, pady=5)
                pt.X_increase_button_large.grid(row=i, column=5, sticky="w", padx=(5), pady=5)
    ...
    def get_attenuation(self):
        try:
            ...
            if points:
                ...
                # hide delete button on end points
                for i, pt in enumerate(self.active_points):
                    if i == 0 or i == len(self.active_points) - 1:
                        pt.delete_button.grid_forget()
